...
print("Running simulation with 10,000 agents, 5000 steps...")
dna = SongDNA(
    rhythm=0.5,
    density=0.5,
    brightness=0.5,
...
# Patch the engine to force 10k agents and 5000 steps
class MidDensityEngine(MandalaEngine):
    def __init__(self, dna, width, height):
        ...
        # Override params for 5000 steps
        self.p = self._params(len(ax))
        self.p.n_steps = 5000


t0 = time.time()
engine = MidDensityEngine(dna, 800, 600)
...
plt.savefig("mpl_test_10k.png", dpi=300, bbox_inches="tight", facecolor="black")
print("Saved mpl_test_10k.png")
